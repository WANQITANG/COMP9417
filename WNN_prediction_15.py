...
def Accuracy(old_labels,predit_lables):
    ...
    # print('1-abs({0}-{1})/{0}'.format(ori_price,pre_price))
...
if __name__ =='__main__':  
    ...
    for K in range(1,50):
        ...
        for i in range(len(data)):
            ...
            # print('training data:',np.array(train_data),'\n','test data:',np.array(test_data),'\n','price:',test_org_lable)
        ...
        # print('yuanlaijiage',len(temp_acc_list))
